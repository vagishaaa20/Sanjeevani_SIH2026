...
export const Sidebar = () => {
    ...
    const linksByRole = {
        ...
        clinic_admin: [
            ...
            { path: '/clinic/diagnostics', label: 'Diagnostics', icon: FileText },
        ],
        doctor: [
            ...
            { path: '/doctor/diagnostics', label: 'Diagnostics', icon: FileText },
        ...
        patient: [
            ...
            { path: '/patient/diagnostics', label: 'Diagnostics', icon: FileText },
    ...
    return (
        ...
        >
            <div className="flex flex-col gap-6">
                ...
                <div className="hidden md:flex flex-col items-start gap-1 pb-4 border-b" style={{ borderColor: 'var(--border)' }}>
